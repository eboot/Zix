/* src/config/nibex-config.h.  Generated from nibex-config.h.in by configure.  */
/* src/config/nibex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Nibex_CONFIG_H

#define Nibex_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.nibex.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nibex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nibex Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nibex"
