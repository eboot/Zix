...
/** Utility functions used by the NIBEX Qt UI.
 */
namespace GUIUtil
{
...
// Render NIBEX addresses in monospace font
...
// Parse "nibex:" URI into recipient object, return true on successful parsing
