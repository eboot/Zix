...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NIBEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nibex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nibex"), this);
    aboutAction->setStatusTip(tr("Show information about Nibex"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NIBEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NIBEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NIBEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a NIBEX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nibex help message to get a list with possible NIBEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nibex client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NIBEX network", "", count));
}
...
{
    QString strTitle = tr("Nibex"); // default title
