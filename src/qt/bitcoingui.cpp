                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ZixCash") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZixCash"), this);
    aboutAction->setStatusTip(tr("Show information about ZixCash"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ZixCash help message to get a list with possible ZIX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZixCash client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("ZixCash"); // default title
