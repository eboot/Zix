...
This means one can have an always-on nibexd instance running, and another local nibexd/nibex-qt instance which connects to this node and receives blocks from it.
