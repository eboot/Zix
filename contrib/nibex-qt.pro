...
RESOURCES += src/qt/nibex.qrc src/qt/nibex_locale.qrc

TRANSLATIONS += src/qt/locale/nibex_bg.ts \
                src/qt/locale/nibex_de.ts \
                src/qt/locale/nibex_en.ts \
                src/qt/locale/nibex_es.ts \
                src/qt/locale/nibex_fi.ts \
                src/qt/locale/nibex_fr.ts \
                src/qt/locale/nibex_it.ts \
                src/qt/locale/nibex_ja.ts \
                src/qt/locale/nibex_pl.ts \
                src/qt/locale/nibex_pt.ts \
                src/qt/locale/nibex_ru.ts \
                src/qt/locale/nibex_sk.ts \
                src/qt/locale/nibex_sv.ts \
                src/qt/locale/nibex_vi.ts \
                src/qt/locale/nibex_zh_CN.ts \
                src/qt/locale/nibex_zh_TW.ts
