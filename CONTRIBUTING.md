Contributing to Nibex
============================

The Nibex project operates an open contributor model where anyone is
...
The following applies to code changes to the Nibex project, and is not to be
confused with overall NIBEX Network Protocol consensus changes.

Whether a pull request is merged into Nibex rests with the project merge
...
Patches that change NIBEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the NIBEX consensus, it must have been
...
The project leader is the release manager for each Nibex release.
