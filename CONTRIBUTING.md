Contributing to ZixCash
============================

The ZixCash project operates an open contributor model where anyone is
...
The following applies to code changes to the ZixCash project, and is not to be
confused with overall ZIX Network Protocol consensus changes.

Whether a pull request is merged into ZixCash rests with the project merge
...
The project leader is the release manager for each ZixCash release.
