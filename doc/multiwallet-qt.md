...
In order to support loading of multiple wallets in nibex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nibex.cpp.
...
Changes to nibex.cpp
----------------------
nibex.cpp is the entry point into nibex-qt, and as such, will require some minor modifications to provide hooks for
