...
In order to support loading of multiple wallets in zixcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zixcash.cpp.
...
Changes to zixcash.cpp
----------------------
zixcash.cpp is the entry point into zixcash-qt, and as such, will require some minor modifications to provide hooks for
